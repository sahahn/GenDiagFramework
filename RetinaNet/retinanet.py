...
import keras
import RetinaNet.initializers as initializers
from RetinaNet.utils.anchors import AnchorParameters
from RetinaNet._misc import UpsampleLike, Anchors, RegressBoxes, ClipBoxes
from RetinaNet.filter_detections import FilterDetections
import numpy as np
...
def get_predictions(training_model, test_gen, score_threshold):
    
    pred_model = retinanet_bbox(training_model)
    max_detections = 1
